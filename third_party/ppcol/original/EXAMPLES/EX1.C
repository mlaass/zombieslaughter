/*****************************************************************************
 ...
 Based on collide.c from Neil Chinnery.
 This program demonstrates the basic functionality of the library showing how
 to create a PPCOL Mask and how to check bounding box collision and pixel
 perfect collision between 2 sprites using the mask method and the normal
 method.
*****************************************************************************/
...
void show_info()
{
 ...
 if( check_bb_collision(sprite_masks[SP1-1], sprite_masks[SP2-1], X1,Y1, X2,Y2) ) { //Check for bounding box collision... you can use the sprites instead of the masks for this... there's no difference!
 ...
 if( check_ppmask_collision(sprite_masks[SP1-1], sprite_masks[SP2-1], X1,Y1, X2,Y2) ) { //Check for pixel perfect collision using the masks.
